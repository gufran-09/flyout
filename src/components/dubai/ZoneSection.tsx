  ...
  return (
    <div className="relative p-8 rounded-[32px] bg-white/10 backdrop-blur-md border border-white/20 shadow-xl my-6 overflow-hidden group hover:bg-white/15 transition-all duration-500">
      ...
      <div className="relative z-10 flex flex-col gap-4">
        ...
        <div className="mt-4">
          <h4 className="text-sm font-semibold text-white/90 uppercase tracking-widest mb-3">
            Experiences
          </h4>
        ...
        {zone.ticketExamples && (
          <div className="mt-6 pt-6 border-t border-white/10">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Button
                variant="ghost"
                className="text-xs text-primary hover:text-primary/80 h-8 p-0 hover:bg-transparent"
              >

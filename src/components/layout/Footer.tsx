          ...
          <div className="space-y-8">
            <Link href="/" className="block">
              <img
                src="/logo.png"
                alt="Flyout Tours"
                className="h-[72px] w-auto object-contain -ml-2"
              />
            </Link>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-display font-light text-white leading-tight">
                Flyout curates the{" "}
                <span className="text-flyout-gold">finest experiences</span>{" "}
                across the Emirates.
              </h2>
              <p className="text-slate-400 font-light leading-relaxed max-w-md">
                From private yacht charters to exclusive desert escapes, we
                design journeys that redefine luxury travel in the UAE.
              </p>
            </div>
            ...
            <div className="flex items-center gap-2 mb-2">
              <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-flyout-gold/10 to-transparent border-l-2 border-flyout-gold rounded-r-lg">
                ...
                <span className="text-xs font-semibold tracking-wider text-flyout-gold uppercase">
                  Licensed UAE Travel Partner
                </span>
              </div>
              ...
              <div className="flex gap-3">
                {[
                  ...
                  {
                    icon: Linkedin,
                    href: "https://www.linkedin.com/company/flyout-tours-llc/posts/?feedView=all",
                  },
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-10 h-10 rounded-full bg-white/5 border border-white/5 flex items-center justify-center text-slate-400 hover:bg-flyout-gold hover:text-black hover:border-flyout-gold transition-all duration-300"
                  >
                    <social.icon size={18} />
                  </a>
                ))}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-12 relative z-10">
              <div>
                ...
                >
                  <MapPin
                    size={18}
                    className="text-flyout-gold shrink-0 mt-0.5 group-hover/link:text-white transition-colors"
                  />
                  <span className="text-slate-300 text-sm group-hover/link:text-white transition-colors">
                    Sharjah Media City,
                    <br />
              ...
              <div>
                ...
                >
                  <Phone
                    size={18}
                    className="text-flyout-gold shrink-0 group-hover/link:text-white transition-colors"
                  />
                  <span className="text-white text-lg font-display tracking-wide group-hover/link:text-flyout-gold transition-colors">
                    +971 54 466 1317
                  </span>
                </a>
              </div>
              ...
              <div>
                ...
                >
                  <Mail
                    ...
                    className="text-flyout-gold shrink-0 group-hover/link:text-white transition-colors"
                  />
                  <span className="text-slate-300 text-sm group-hover/link:text-white transition-colors cursor-pointer">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="max-w-xl text-center lg:text-left">
              <h3 className="text-2xl font-display text-white mb-2">
                Get exclusive UAE travel deals
              </h3>
              <p className="text-slate-400 font-light">
                Join our concierge list for private offers and curated
                experiences.
              </p>
            </div>
            ...
            <div className="w-full max-w-md bg-white/5 p-1.5 rounded-full border border-white/10 flex focus-within:border-flyout-gold/50 transition-colors shadow-2xl shadow-black/20">
              ...
              />
              <button
                className="bg-flyout-gold text-black px-8 py-3 rounded-full text-sm font-bold tracking-wide 
      ...
      <div className="section-container px-4 md:px-6 lg:px-8 max-w-7xl mx-auto mb-20">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 lg:gap-16">
          {[
            ...
            <div key={idx}>
              <h4 className="text-lg font-display text-white mb-8 block">
                {section.title}
              </h4>
              <ul className="space-y-4">
                {section.links.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-slate-400 font-light hover:text-flyout-gold hover:pl-2 transition-all duration-300 text-sm block"
                    >
                      {link.name}
                    </Link>
                  </li>
      ...
      <div className="section-container px-4 md:px-6 lg:px-8 max-w-7xl mx-auto mb-12">
        <div className="flex flex-col items-center justify-center gap-8 border-t border-white/5 pt-12">
          ...
          <div className="bg-white/[0.03] border border-white/5 rounded-full px-8 py-3 backdrop-blur-sm flex items-center justify-center gap-8 shadow-2xl">
            <div className="flex items-center gap-2">
              ...
              <div className="flex gap-0.5">
                {[1, 2, 3, 4, 5].map((s) => (
                  <div key={s} className="bg-[#00b67a] p-0.5 rounded-[1px]">
          ...
          <p className="text-center font-display italic text-lg text-slate-500 opacity-60">
            "From sky to sea, desert to skyline — Flyout designs journeys worth
            remembering."
          </p>
        </div>
      </div>
        ...
        <div className="section-container px-4 md:px-6 lg:px-8 max-w-7xl mx-auto py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <Link
                href="/privacy"
                className="text-[11px] text-slate-600 hover:text-flyout-gold transition-colors uppercase tracking-wider font-medium"
              >
                Privacy
              </Link>
              <Link

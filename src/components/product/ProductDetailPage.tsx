...
function Breadcrumb({ product }: { product: Product }) {
  ...
  const normalizedCategorySlug = rawCategorySlug
    ...
    : "";
  const categoryHref = normalizedCategorySlug
    ? `/dubai/${normalizedCategorySlug}`
    : "/dubai";
      ...
      {meta.floor_level && (
        <div className="bg-[#F5F0E8] rounded-xl p-3">
          ...
          <p className="font-semibold text-[#1A2B47]">
            {meta.floor_level}th Floor
          </p>
        </div>
      )}
      {meta.tier && (
        <div className="bg-[#F5F0E8] rounded-xl p-3">
          <p className="text-xs text-gray-500">Experience Tier</p>
          <p className="font-semibold text-[#1A2B47]">{meta.tier}</p>
        </div>
      )}
      {meta.skip_the_line && (
        <div className="bg-green-50 rounded-xl p-3 flex items-center gap-2">
          <Zap className="w-4 h-4 text-green-600" />
          <p className="font-semibold text-green-700 text-sm">Skip The Line</p>
        </div>
      )}
      {meta.views && (
        <div className="bg-[#F5F0E8] rounded-xl p-3 col-span-2">
          <p className="text-xs text-gray-500 mb-1">Views</p>
          <div className="flex flex-wrap gap-1">
            {meta.views.map((v: string, i: number) => (
              <span
                key={i}
  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-3 gap-3">
        {meta.yacht_length_ft && (
          <div className="bg-[#EEF4FB] rounded-xl p-3 text-center">
            <p className="text-lg font-bold text-[#1A2B47]">
              {meta.yacht_length_ft}ft
            </p>
        ...
        {meta.tour_type && (
          <div className="bg-[#EEF4FB] rounded-xl p-3 text-center">
            <p className="text-sm font-bold text-[#1A2B47] capitalize">
              {meta.tour_type}
            </p>
      ...
      {meta.amenities && (
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {meta.amenities.map((a: string, i: number) => (
              <span
                key={i}
                className="text-xs bg-[#EEF4FB] text-[#1A2B47] px-3 py-1 rounded-full"
              >
                {a}
              </span>
            ))}
      ...
      {meta.route_options && (
        <div>
          ...
          <div className="space-y-1">
            {meta.route_options.map((r: string, i: number) => (
              <div
                key={i}
                className="flex items-center gap-2 text-sm text-gray-600"
              >
                <Anchor className="w-3 h-3 text-[#D4A853]" />
                {r}
              </div>
            ))}
          </div>
...
function SafariMeta({ meta }: { meta: Record<string, any> }) {
  return (
    <div className="space-y-3">
      ...
      {meta.activities_included && (
        <div>
          <p className="text-sm font-medium text-gray-700 mb-2">
            Activities Included
          </p>
          <div className="grid grid-cols-2 gap-1">
            {meta.activities_included.map((a: string, i: number) => (
              <div
                key={i}
                className="flex items-center gap-2 text-sm text-gray-600"
              >
                <Check className="w-3 h-3 text-[#D4A853] flex-shrink-0" />
                {a}
              </div>
            ))}
          </div>
      ...
      {meta.dress_code && (
        <div className="flex items-start gap-2 bg-orange-50 rounded-xl p-3">
          ...
          <div>
            <p className="text-xs font-medium text-orange-700">Dress Code</p>
            <p className="text-sm text-orange-600">{meta.dress_code}</p>
          </div>
        </div>
      )}
    </div>
        ...
        {meta.star_rating && (
          <div className="bg-amber-50 rounded-xl p-3 text-center">
            <p className="text-lg font-bold text-amber-600">
              {"★".repeat(meta.star_rating)}
            </p>
            <p className="text-xs text-gray-500">{meta.star_rating} Star</p>
          </div>
        )}
        {meta.check_in_time && (
          <div className="bg-[#EEF4FB] rounded-xl p-3 text-center">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {meta.amenities.map((a: string, i: number) => (
              <span
                key={i}
                className="text-xs bg-[#F5F0E8] px-3 py-1 rounded-full text-gray-700"
              >
                {a}
              </span>
            ))}
...
function CarMeta({ meta }: { meta: Record<string, any> }) {
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-3">
        {meta.vehicle_class && (
          <div className="bg-[#1A2B47] rounded-xl p-3 text-center">
            <p className="text-sm font-bold text-[#D4A853] capitalize">
              {meta.vehicle_class.replace("_", " ")}
            </p>
            <p className="text-xs text-gray-300">Vehicle Class</p>
          </div>
        )}
        {meta.minimum_age && (
          <div className="bg-[#EEF4FB] rounded-xl p-3 text-center">
      ...
      {meta.license_required && (
        <div className="flex items-start gap-2 bg-blue-50 rounded-xl p-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-600">{meta.license_required}</p>
          </div>
        </div>
      )}
    </div>
  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-3">
        ...
        {meta.weight_limit_kg && (
          <div className="bg-[#EEF4FB] rounded-xl p-3 text-center">
            <p className="text-lg font-bold text-[#1A2B47]">
              {meta.weight_limit_kg}kg
            </p>
            <p className="text-xs text-gray-500">Max Weight</p>
          </div>
        )}
      </div>
      {meta.weather_dependent && (
        <div className="flex items-start gap-2 bg-yellow-50 rounded-xl p-3">
          <Wind className="w-4 h-4 text-yellow-600 flex-shrink-0 mt-0.5" />
          <div>
            <p className="text-xs font-medium text-yellow-700">
              Weather Dependent
            </p>
            <p className="text-xs text-yellow-600">
              {meta.cancellation_note || "May be rescheduled due to weather"}
            </p>
          </div>
        </div>
      )}
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {meta.views.map((v: string, i: number) => (
              <span
                key={i}
                className="text-xs bg-sky-50 border border-sky-200 text-sky-700 px-2 py-1 rounded-full"
              >
                {v}
              </span>
            ))}
  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-3">
        ...
        {meta.activity_type && (
          <div className="bg-cyan-50 rounded-xl p-3 text-center">
            <p className="text-sm font-bold text-cyan-700 capitalize">
              {meta.activity_type.replace("_", " ")}
            </p>
      ...
      <div className="grid grid-cols-2 gap-2">
        {meta.equipment_provided && (
          <div className="flex items-center gap-2 p-2 rounded-lg bg-green-50">
            <Check className="w-3 h-3 text-green-500" />
            <span className="text-xs">Equipment Provided</span>
          </div>
        )}
        {meta.instructor_available && (
          <div className="flex items-center gap-2 p-2 rounded-lg bg-green-50">
            <Check className="w-3 h-3 text-green-500" />
            <span className="text-xs">Instructor Available</span>
          </div>
        )}
      </div>
      {meta.skill_levels && (
        <div>
          ...
          <div className="flex gap-2 flex-wrap">
            {meta.skill_levels.map((s: string, i: number) => (
              <span
                key={i}
                className="text-xs bg-cyan-50 text-cyan-700 px-3 py-1 rounded-full capitalize"
              >
                {s}
              </span>
            ))}
...
function DinnerCruiseMeta({ meta }: { meta: Record<string, any> }) {
  return (
    <div className="space-y-3">
      {meta.route && (
        <div className="flex items-center gap-3 bg-[#EEF4FB] rounded-xl p-3">
          <Anchor className="w-5 h-5 text-[#1A2B47]" />
          <div>
            <p className="text-xs text-gray-500">Cruise Route</p>
            <p className="font-semibold text-[#1A2B47]">{meta.route}</p>
          </div>
        </div>
      )}
      {meta.landmark_views && (
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {meta.landmark_views.map((l: string, i: number) => (
              <span
                key={i}
                className="text-xs bg-[#F5F0E8] px-2 py-1 rounded-full"
              >
                {l}
              </span>
            ))}
      ...
      {meta.entertainment_type && (
        <div>
          <p className="text-sm font-medium text-gray-700 mb-2">
            Entertainment
          </p>
          <div className="grid grid-cols-2 gap-1">
            {meta.entertainment_type.map((e: string, i: number) => (
              <div
                key={i}
                className="flex items-center gap-2 text-sm text-gray-600"
              >
      ...
      {meta.dress_code && (
        <div className="flex items-center gap-2 bg-gray-50 rounded-xl p-3">
          ...
          <p className="text-sm text-gray-600">
            Dress Code: <span className="font-medium">{meta.dress_code}</span>
          </p>
        </div>
      )}
    </div>
...
function HolidayPackageMeta({ meta }: { meta: Record<string, any> }) {
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-3">
        {meta.destination_country && (
          <div className="bg-[#EEF4FB] rounded-xl p-3">
            <p className="text-xs text-gray-500">Destination</p>
            <p className="font-semibold text-[#1A2B47]">
              {meta.destination_city || meta.destination_country}
            </p>
          </div>
        )}
        {(meta.duration_days || meta.duration_nights) && (
          <div className="bg-[#EEF4FB] rounded-xl p-3">
            <p className="text-xs text-gray-500">Duration</p>
            <p className="font-semibold text-[#1A2B47]">
              {meta.duration_days && `${meta.duration_days}D`}
              {meta.duration_nights && `/${meta.duration_nights}N`}
            </p>
          </div>
        )}
      </div>
      <div className="grid grid-cols-2 gap-2">
        {meta.flights_included !== undefined && (
          <div
            className={`flex items-center gap-2 p-2 rounded-lg ${meta.flights_included ? "bg-green-50" : "bg-gray-50"}`}
          >
            <Plane
              className={`w-3 h-3 ${meta.flights_included ? "text-green-500" : "text-gray-400"}`}
            />
            <span className="text-xs text-gray-700">Flights Included</span>
          </div>
        )}
        {meta.hotel_included !== undefined && (
          <div
            className={`flex items-center gap-2 p-2 rounded-lg ${meta.hotel_included ? "bg-green-50" : "bg-gray-50"}`}
          >
            <Home
              className={`w-3 h-3 ${meta.hotel_included ? "text-green-500" : "text-gray-400"}`}
            />
            <span className="text-xs text-gray-700">Hotel Included</span>
          </div>
        )}
      </div>
    </div>
...
function VisaMeta({ meta }: { meta: Record<string, any> }) {
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-3 gap-3">
        {meta.validity_days && (
          <div className="bg-[#EEF4FB] rounded-xl p-3 text-center">
            ...
            <p className="text-xs text-gray-500">Days Valid</p>
          </div>
        )}
        {meta.processing_time_days && (
          <div className="bg-[#EEF4FB] rounded-xl p-3 text-center">
            <p className="text-xl font-bold text-[#1A2B47]">
              {meta.processing_time_days}
            </p>
            <p className="text-xs text-gray-500">Processing Days</p>
          </div>
        )}
        {meta.entry_type && (
          <div className="bg-[#EEF4FB] rounded-xl p-3 text-center">
      ...
      {meta.required_documents && (
        <div>
          <p className="text-sm font-medium text-gray-700 mb-2">
            Required Documents
          </p>
          <div className="space-y-1">
            {meta.required_documents.map((d: string, i: number) => (
              <div
                key={i}
                className="flex items-start gap-2 text-sm text-gray-600"
              >
                <FileText className="w-3 h-3 text-[#D4A853] flex-shrink-0 mt-0.5" />
                {d}
              </div>
            ))}
          </div>
...
function CruiseMeta({ meta }: { meta: Record<string, any> }) {
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-3 gap-3">
        {meta.duration_nights && (
          <div className="bg-[#1A2B47] rounded-xl p-3 text-center">
            <p className="text-xl font-bold text-white">
              {meta.duration_nights}
            </p>
            <p className="text-xs text-gray-300">Nights</p>
          </div>
        )}
        {meta.departure_port && (
          <div className="bg-[#EEF4FB] rounded-xl p-3 text-center">
            <p className="text-xs font-bold text-[#1A2B47]">
              {meta.departure_port}
            </p>
...
function BookingCard({ product }: { product: Product }) {
  ...
  const durationGroups = allPricings.reduce(
    (acc, p) => {
  ...
  const hasPassengerTypes = allPricings.some(
  ...
  const adultPricing =
    currentPricings.find((p) => p.passenger_type === "adult") ||
    currentPricings[0];
  const childPricing = currentPricings.find(
    (p) => p.passenger_type === "child",
  );
  const infantPricing = currentPricings.find(
  ...
  const originalTotal = adultOriginal
    ? adultOriginal * adults +
      (childPricing?.original_price ?? childPricing?.price ?? 0) * children
    : null;

  const discountPercent =
    adultPricing?.discount_percent ??
  ...
  const supplierCode =
    product.product_suppliers.find((s) => s.is_active)?.supplier?.code ||
      ...
      <div className="space-y-3">
          ...
          <div className="flex flex-col">
            ...
            {product.max_people && (
              <span className="text-xs text-muted-foreground">
                Max {product.max_people} people per pack
              </span>
            )}
            {adultPricing && !product.max_people && (
              <span className="text-xs text-gray-400">
                AED {adultPricing.price} per person
                {adultPricing.min_age ? ` (${adultPricing.min_age}+ yrs)` : ""}
              </span>
            )}
          </div>
          ...
          <div className="flex items-center justify-between border border-gray-200 rounded-lg p-3">
            <div className="flex flex-col">
              ...
              <span className="text-xs text-gray-400">
                ...
                {childPricing.min_age != null && childPricing.max_age != null
                  ? ` (${childPricing.min_age}–${childPricing.max_age} yrs)`
                  : ""}
              </span>
            </div>
            <div className="flex items-center gap-3">
        ...
        {hasPassengerTypes && infantPricing && infantPricing.price === 0 && (
          <div className="flex items-center gap-2 bg-green-50 rounded-lg p-2 text-xs text-green-700">
            ...
            Infants (0–{infantPricing.max_age ?? 2} yrs) admitted free
          </div>
        )}
      </div>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            {durationKeys.map((key) => {
              ...
              const adultP =
                pricings.find((p) => p.passenger_type === "adult") ||
                pricings[0];
              return (
                <button
                  key={key}
      ...
      {children > 0 && childPricing && (
        <div className="bg-gray-50 rounded-xl p-3 space-y-1 text-sm border border-gray-100">
          <div className="flex justify-between text-gray-600">
            <span>
              {adults} Adult{adults > 1 ? "s" : ""} × AED{" "}
              {adultPricing?.price ?? 0}
            </span>
            <span>AED {adultTotal.toLocaleString()}</span>
          </div>
          <div className="flex justify-between text-gray-600">
            <span>
              {children} Child{children > 1 ? "ren" : ""} × AED{" "}
              {childPricing.price}
            </span>
...
export default function ProductDetailPage({ product }: { product: Product }) {
  ...
  const metaTitle =
    product.category?.slug === "hotel"
      ? "Hotel Details"
      : product.category?.slug === "yacht"
        ? "Yacht Details"
        : product.category?.slug === "safari"
          ? "Safari Details"
          : product.category?.slug === "car"
            ? "Vehicle Details"
            : product.category?.slug === "vise-services"
              ? "Visa Details"
              : product.category?.slug === "holiday-package"
                ? "Package Details"
                : "Activity Details";
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                {product.confirmation_hours <= 24 && (
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-100 rounded-md text-sm text-gray-700">
                    ...
                    <span>{product.confirmation_hours} Hour Confirmation</span>
                  </div>
                )}
                  ...
                  <AccordionItem value="details" className="border-b">
                    ...
                    <AccordionContent>
                      <div className="pt-2 pb-4">
                        <CategoryMetaContent product={product} />
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                )}
                  ...
                  <AccordionItem value="whatToBring" className="border-b">
                    ...
                    <AccordionContent>
                      <ul className="list-disc list-inside space-y-2 text-gray-600 text-base pt-2 pb-4">
                        {product.what_to_bring.map((item, idx) => (
                          <li key={idx}>{item}</li>
                        ))}
                      </ul>
                    </AccordionContent>
                    ...
                    <AccordionContent>
                      <div className="flex flex-wrap gap-2 pt-2 pb-4">
                        {product.facilities.map((item, idx) => (
                          <span
                            key={idx}
                            className="px-3 py-1 bg-gray-100 rounded-full text-sm text-gray-600 border border-gray-200"
                          >
                            {item}
                          </span>
                        ))}

...
export const PRODUCTS: Product[] = [
    ...
    --------------------------------------------------- */
  {
    ...
    whatToBring: ["Passport or Emirates ID", "Swimwear", "Towel", "Sunscreen"],
...

  {
    ...
    cancellationPolicy: "Cancel at least 24 hours prior for a full refund.",
  ...
  },
  {
    ...
    cancellationPolicy: "Cancel 24 hours in advance for a full refund.",
  ...
  },
  {
    ...
    facilities: ["Lockers", "Changing Rooms", "Instructor", "Life Jackets"],
  ...
  },
  {
    ...
    whatToBring: ["Original Emirates ID or Passport", "Swimwear", "Towel"],

    facilities: ["Changing Rooms", "Lockers", "Life Jackets", "Instructor"],
  ...
  },
  {
    ...
    images: [
      "https://bfzhzxyjjkcctxnmzafb.supabase.co/storage/v1/object/public/media/products/Water-Sports/Tubing/Tubing.webp",
    ],
    ...
    facilities: ["Changing Rooms", "Lockers", "Instructor", "Life Jackets"],

    cancellationPolicy: "Cancel 24 hours before activity for full refund.",
  ...
  },
  {
    ...
    facilities: ["Life Jacket", "Delivery Service"],
  ...
  },
  {
    ...
    overview:
      "Seawake Water Sports Inflatable Park is more than just a water attraction; it's a paradise where memories are made. Laughter is shared, and the allure of the ocean's depths is brought to life. Come join us and experience the magic of this aquatic haven, where every moment is an opportunity to create cherished memories and embark on an aquatic adventure like no other. Dive in, let your cares float away, and make a splash at Seawake Water Sports Inflatable Park.",
    ...
    facilities: ["Life Jackets", "Safety Staff", "Changing Rooms", "Lockers"],
  ...
  },
  {
    ...
    overview:
      "Get ready for an exhilarating adventure like no other as you hop on board the thrilling Flyfish! It's not just a water sled; it's an aerial inflatable water sled that's towed by a powerful boat. As you hold on tight, you'll experience the rush of high speeds that the Flyfish can achieve, and here's the twist: these incredible speeds cause this wide watercraft to literally take flight!",
    ...
    facilities: ["Life Jackets", "Professional Staff", "Safety Briefing"],
  ...
  },
  {
    ...
    overview:
      "Fujairah is one of the parts of the UAE that still needs to be correctly discovered by many tourists. The underwater world of Fujairah is so pristine that many tourists consider it one of the best areas for snorkeling. Now we at Dojoin have decided to provide conditions in cooperation with Sea Wake entertainment company so that you can experience snorkeling in the best way in the waters of Fujairah. Fujairah Snorkeling Adventure gives you the opportunity to swim and explore vibrant marine life in crystal-clear waters.",
  ...
  },
  {
    ...
    overview:
      "Explore Dubai's waterways in style aboard our modern gozzos, seamlessly blending cityscapes with cultural heritage. Indulge in leisure on water or step ashore for immersive experiences, all while enjoying the freedom and opulence our gozzos offer. Book now for a Dubai odyssey like no other! Ready to make a splash? Embrace the thrill of water adventure with Cha Cha Boats — where the sea meets unforgettable experiences! Book your voyage now and dive into luxury on the water.",
    ...
    whatToBring: ["Original Emirates ID or Passport", "Sunglasses", "Camera"],
  ...
  },
  {
    ...
    overview:
      "An exciting new world of opportunities is accessible to thrill seekers at Deep Dive Dubai. Everyone can explore an underwater world full of adventure and wonder thanks to the world's deepest pool, which is 60 meters deep. Deep Dive Dubai's 1,500 square meter facility is situated in the Nad Al Sheba district of Dubai and offers the most cutting-edge equipment for filming, as well as an amazing 'sunken city' for divers to explore.",
  ...
  },
  {
    ...
    whatToBring: ["Original Emirates ID or Passport", "Swimwear", "Sunglasses"],

    facilities: ["Life Jackets", "Safety Briefing", "Professional Staff"],
  ...
  },
  {
    ...
    subtitle:
      "A premium 5-hour yacht experience filled with adventure, relaxation, and unforgettable coastal moments.",
  ...
  },
  {
    ...
    overview:
      "Have you ever imagined riding an inflatable boat with your loved ones? Undoubtedly, driving a boat on the blue shores of the Arabian Gulf is one of the entertainments that not only you but many tourists who have traveled to Dubai have not had such a special experience yet. Dubai Harbour Signature Boat Tour is a one-time opportunity where you can ride on inflatable boats without any guide and enjoy a unique new entertainer in Dubai.",
  ...
  },
  {
    ...
    whatToBring: ["Original Passport", "Swimwear", "Sunscreen", "Towel"],
  ...
  },
  {
    ...
    overview:
      "Imagine the excitement of Olympic-style paddling, where a solo or duo of paddlers navigates the challenging river. Now, in Dubai, you can have a similar experience, but with a twist—it's not a competition; it's pure entertainment. Thanks to the inventive concept from Hydro Water Sports Corporation, you can paddle single or double kayaks on the Arabian Gulf and bask in the radiant sun. Picture yourself paddling around Palm Jumeirah with the stunning skyline as your backdrop.",

...
export default function Partner() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.from("partners_applications").insert([
        {
      ...
      toast({
        ...
        description:
          "Thank you for applying. We'll be in touch within 48 hours.",
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-[#020617]">
        ...
        <div className="section-container relative z-10 text-center max-w-4xl px-4">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-display text-white mb-6 leading-tight animate-slide-up">
            Partner with the <br />
            <span className="text-[#BE9B57] italic">finest curation</span> of
            UAE experiences.
          </h1>
          ...
          <p className="text-lg md:text-xl text-slate-300 font-light max-w-2xl mx-auto mb-10 leading-relaxed animate-slide-up stagger-1">
            Join Flyout’s exclusive network of verified partners. Connect with
            high-value travelers seeking exceptional journeys, from private
            yacht charters to bespoke desert escapes.
          </p>
        ...
        <div className="section-container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 font-light text-lg">
              We don't just list tours; we elevate brands. Our platform is
              designed for operators who prioritize quality, safety, and guest
              satisfaction.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100/50 shadow-sm hover:shadow-lg transition-all duration-300 group">
              ...
              <h3 className="text-xl font-display text-[#020617] mb-3">
                Global Reach
              </h3>
              <p className="text-slate-600 leading-relaxed text-sm">
                Access a curated audience of international travelers from key
                markets including Europe, USA, and CIS who value premium
                service.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100/50 shadow-sm hover:shadow-lg transition-all duration-300 group">
              ...
              <p className="text-slate-600 leading-relaxed text-sm">
                Position your experiences alongside the UAE’s most reputable
                operators. We maintain strict quality standards to ensure trust.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100/50 shadow-sm hover:shadow-lg transition-all duration-300 group">
              ...
              <p className="text-slate-600 leading-relaxed text-sm">
                Our advanced booking engine handles availability, payments, and
                confirmations instantly, letting you focus on operations.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="section-container relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            ...
            <p className="text-slate-400 font-light max-w-md text-right md:text-left">
              We partner with direct operators and asset owners across key
              verticals.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Private luxury yachts & boats",
              },
              {
                icon: Tent,
                title: "Desert Safaris",
                desc: "Premium & heritage camps",
              },
              {
                icon: Ticket,
                title: "Attractions",
                desc: "Theme parks & landmarks",
              },
              {
                icon: Building2,
                title: "Hospitality",
                desc: "Resorts & staycations",
              },
            ].map((item, idx) => (
              <div
                key={idx}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1 space-y-8">
              <h2 className="text-3xl md:text-5xl font-display text-[#020617] leading-tight">
                Built for{" "}
                <span className="text-[#BE9B57]/80 italic">growth</span>.
                <br />
                Powered by data.
              </h2>
              <p className="text-slate-600 text-lg font-light leading-relaxed">
                Our supplier dashboard gives you full control. Manage inventory,
                track bookings in real-time, and access detailed analytics to
                optimize your performance on Flyout.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Sync your calendars seamlessly",
                  },
                  {
                    title: "Automated Payouts",
                    desc: "Weekly transfers to your account",
                  },
                  {
                    title: "Dedicated Account Manager",
                    desc: "Support for content & pricing",
                  },
                ].map((feature, i) => (
                  <div key={i} className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-[#020617] font-medium">
                        {feature.title}
                      </h4>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                      ...
                      <div className="text-2xl text-white font-display mt-1">
                        AED 142,500
                      </div>
                  ...
                  <div className="h-32 rounded-xl bg-white/5 border border-white/10 flex items-end justify-between p-4 gap-2">
                    {[40, 65, 45, 80, 55, 70, 90, 60].map((h, i) => (
                      <div
                        key={i}
                        style={{ height: `${h}%` }}
                        className="w-full bg-[#BE9B57]/20 rounded-t-sm hover:bg-[#BE9B57]/40 transition-colors"
                      />
                    ))}
                  </div>
                </div>
        ...
        <div className="section-container max-w-4xl">
          <div className="bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden flex flex-col md:flex-row">
            ...
            <div className="bg-[#020617] text-white p-10 md:w-2/5 flex flex-col justify-between relative overflow-hidden">
              ...
              <div>
                ...
                <p className="text-slate-300 font-light text-sm mb-8">
                  Fill out the form to become a Flyout partner. Our team reviews
              ...
              <div className="mt-12">
                ...
                <a
                  ...
                  className="text-[#BE9B57] hover:underline"
                >
            ...
            <div className="p-10 md:w-3/5">
              <h3 className="text-2xl font-display text-[#020617] mb-6">
                Company Details
              </h3>

          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed mb-4">
                We understand that plans can change. You may cancel your booking
                at any time, subject to the following conditions and fees:
              </p>
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed mb-4">
                To cancel your booking, you may use any of the following
                methods:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-foreground/80">
                <li>Log into your account and cancel through the dashboard</li>
                <li>
                  Email us at bookings@flyouttours.com with your booking
                  reference
                </li>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-foreground mb-4">
                3. Cancellation by Flyout Tours
              </h2>
              <p className="text-foreground/80 leading-relaxed mb-4">
                We reserve the right to cancel bookings under the following
                circumstances:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-foreground/80">
              ...
              <p className="text-foreground/80 leading-relaxed mt-4">
                In such cases, you will be offered a full refund or the option
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed mb-4">
                As an alternative to cancellation, you may reschedule your
                booking:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-foreground/80">
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed">
                If you fail to arrive at the designated meeting point without
                prior cancellation or notification, it will be considered a
                no-show. No refunds will be provided for no-shows, and the full
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed">
                For group bookings of 10 or more participants, special
                cancellation terms may apply. Please contact our group sales
                team for specific terms and conditions related to your booking.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed">
                Some promotional packages, flash sales, or special offers may
                have different cancellation terms. These will be clearly stated
                at the time of booking. Please review the specific terms before

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-muted-foreground lg:mx-auto">
              We are dedicated to providing the best travel experiences in Dubai
              and Abu Dhabi, ensuring every journey is safe, exciting, and
              memorable.
            </p>
          </div>
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <div className="ml-16 mt-2 text-base text-muted-foreground">
                  Your safety and security are our top priorities. We partner
                  with licensed and reputable operators.
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16 mt-2 text-base text-muted-foreground">
                  We curate only the best tours and activities to ensure

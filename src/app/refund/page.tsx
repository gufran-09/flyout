          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed">
                At Flyout Tours, we strive to provide exceptional travel
                experiences. We understand that circumstances may change, and we
                have established this refund policy to ensure transparency and
                fairness in our dealings with customers.
              </p>
            </section>
            ...
            <section>
              ...
              <ol className="list-decimal pl-6 space-y-2 text-foreground/80">
                <li>
                  Submit a refund request via email or through your account
                  dashboard
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-foreground/80">
                <li>
                  Third-party fees (visa processing, transportation add-ons)
                </li>
                <li>No-show without prior cancellation</li>
                <li>
                  Special promotions or discounted packages (unless otherwise
                  stated)
                </li>
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed">
                If you participated in part of a tour and wish to claim a
                partial refund for unused services, please contact our support
                team. Each case will be evaluated individually based on the
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed">
                Instead of a refund, you may opt to receive a credit for future
                bookings. Credits are valid for 12 months from the date of issue
                and can be applied to any Flyout Tours service.
              </p>
            </section>
